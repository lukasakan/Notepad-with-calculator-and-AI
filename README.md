...
its a notepad made with Python and PyQt5. You can create pages and type notes. Everything is saved in a database. It autosaves, so when you close it and open it will  save the page you were on and the notes that you were taking
